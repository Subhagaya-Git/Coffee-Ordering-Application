...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeOrderBtn = findViewById(R.id.placeOrderBtnID2);
        ...
        seekBarSugar = findViewById(R.id.seekBarSugarID2);
        seekBarNumOfCup = findViewById(R.id.seekBarCupID2);
        textViewSugar = findViewById(R.id.textVieSugarID2);
        textViewNumOfCup = findViewById(R.id.textVieCupID2);
        textViewTotalAmt = findViewById(R.id.textVieTotalAmtID2);
        backBtn = findViewById(R.id.imageBackID2);
        ...
        placeOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(MainActivity6.this, "Please select Hot or Cold coffee", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(MainActivity6.this, "Order Successsful!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}